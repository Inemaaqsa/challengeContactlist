package com.danielgoldberg.contactlist.fragment;
...
import com.danielgoldberg.contactlist.ContactListApplication;
import com.danielgoldberg.contactlist.R;
import com.danielgoldberg.contactlist.model.Address;
...
public class ContactDetailFragment extends Fragment {
    ...
    private void setBirthdate(){
        ...
        cal.setTimeInMillis(contact.getBirthdate());
        String format = "MMMM dd, yyyy";
        DateFormat fmt = new SimpleDateFormat(format, Locale.US);
        contactBirthday.setText(fmt.format(cal.getTime()));
    }
